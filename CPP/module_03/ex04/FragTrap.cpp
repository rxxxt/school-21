...
FragTrap::FragTrap() : ClapTrap("Default",
													  ...
													  20,
													  5) {
	std::cout << BYELLOW << "<" << _name << ">" << RESET << GREEN << " brand new assault robot FR4G-TP came off the assembly line\n" << RESET;
}
...
FragTrap::~FragTrap() {
	std::cout << BLUE << "FragTrap " << BYELLOW << "<" << _name << ">" << RESET << BLUE << " has been sent for recycling\n";
}
